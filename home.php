...
<body class="bg-gray-50">
            ...
            <div class="grid gap-8 lg:grid-cols-12">
                <div class="lg:col-span-7">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="pendaftaran.php" class="btn-primary inline-flex items-center px-6 py-3 text-base font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800">
                            Daftar Sekarang
                            <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                        </a>
                        <a href="kurikulum.php" class="btn-secondary inline-flex items-center px-6 py-3 text-base font-medium text-blue-700 border border-blue-700 rounded-lg hover:bg-gray-100">
                            Lihat Kurikulum
                        </a>
                    </div>
                </div>
                <div class="hidden lg:col-span-5 lg:flex">
                    <img src="images/hero-image.jpg" alt="Suasana Pembelajaran di Lab" class="rounded-lg shadow-lg object-cover">
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Statistik -->
    <section class="stats-section py-8 bg-blue-700">
        <div class="max-w-screen-xl px-4 mx-auto">
            <div class="grid grid-cols-2 gap-4 md:grid-cols-4">
                <div class="text-center text-white program-card">
    ...
    <section class="py-12 bg-gray-50">
        <div class="max-w-screen-xl px-4 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                <!-- Program 1 -->
                <div class="program-card p-6 bg-white rounded-lg shadow-lg">
            ...
            if ($berita_terkini): ?>
                <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                    <?php foreach ($berita_terkini as $berita): ?>
                        <article class="news-card overflow-hidden rounded-lg shadow transition hover:shadow-lg">
                            <img
                                src="<?= htmlspecialchars($berita['gambar']) ?>"
                                alt="<?= htmlspecialchars($berita['judul']) ?>"
                                class="h-56 w-full object-cover">
                            <div class="bg-white p-4 sm:p-6">
                                <time datetime="<?= htmlspecialchars($berita['tanggal']) ?>" class="block text-xs text-gray-500">
                                    <?= formatTanggal($berita['tanggal']) ?>
                                </time>
                                <h3 class="mt-0.5 text-lg font-medium text-gray-900 hover:text-blue-700">
                                    <a href="berita.php?id=<?= htmlspecialchars($berita['id']) ?>">
                ...
                <div class="mt-8 text-center">
                    <a href="berita.php" class="btn-secondary inline-flex items-center px-6 py-3 text-base font-medium text-blue-700 border border-blue-700 rounded-lg hover:bg-gray-100">
                        Lihat Semua Berita
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
